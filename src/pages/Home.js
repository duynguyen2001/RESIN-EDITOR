...
function Home() {
  ...
  function handleFileDownload() {
    ...
    const dataToDownload = [{ x: 50, y: 50, r: 25, color: 'red' }, { x: 100, y: 100, r: 50, color: 'blue' }];
  ...
  return (
    <div>
      ...
      <ColorPicker value={circleColor} onChange={(e) => setCircleColor(e.target.value)} />
      <RadiusInput value={circleRadius} onChange={(e) => setCircleRadius(e.target.value)} />
